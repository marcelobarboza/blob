...
bool test_for_leap_years(int year) {
...
bool test_for_days_in_month(int year, int month) {
...
bool from_ordinal_cancels_out_to_ordinal(date_t date) {
...
bool to_ordinal_cancels_out_from_ordinal(int n) {
